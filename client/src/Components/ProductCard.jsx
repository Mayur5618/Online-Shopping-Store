...
export default function ProductCard({ width, product }) {
  ...
  return (
    <div
      className={`${cardWidth} ${cardHeight} sm:mt-5 mt-1 rounded-md shadow-2xl relative sm:h-[335px] group sm:w-[300px] mx-auto dark:bg-transparent transition-all border border-sky-400 mb-2 overflow-hidden`}
    >
      ...
      <div className={`flex sm:p-3 ${padding} flex-col`}>
        ...
        <Link
          ...
          className="z-10 hidden sm:block group-hover:bottom-0 border !rounded-tl-none border-teal-500 p-2 rounded-md absolute left-0 right-0  bottom-[-100px] text-center m-2 hover:bg-purple-500"
        >
          See Details
        </Link>
      </div>
